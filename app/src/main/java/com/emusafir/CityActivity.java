...
public class CityActivity  extends AppCompatActivity implements OnCitySelected {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mAdapter = new CityAdapter(CityActivity.this, mList,this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(CityActivity.this, RecyclerView.VERTICAL, false);
...
//                getSupportActionBar().setTitle(String.valueOf(0 + " Selected"));
    ...
    public void checkConnection() {
        ...
        if (isConnected) {
            ...
            Utils.showMessage(getString(R.string.not_connected_to_internet), CityActivity.this);
                ...
                try {
                    ...
                    if (response.code() == 200) {
                        ...
                        switch (response.code()) {
                            case 500:
                                Utils.showMessage("Internal Server Error", CityActivity.this);
                                break;
                            default:
                                JSONObject jsonObject = new JSONObject(response.errorBody().string());
                                if (jsonObject.has("message")) {
                                    Utils.showMessage(jsonObject.getString("message"), CityActivity.this);
                                }
                                break;
                        }
                    }
